...
import 'package:trial/components/gradient_color.dart'; // Import the GradientColor class
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    // Adds spacing before the checkbox
        ...
        child: Container(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              ...
              // For now, navigate to HomePage when button is pressed
