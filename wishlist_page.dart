...
import 'bottom_nav_bar.dart'; // Import BottomNavBar here
    ...
    final List<Map<String, String>> favoritePlaces = [
      {
        ...
        'image': 'assets/images/paris.jpg', // Replace with actual image path
      },
      {
        'name': 'Bali',
        'description': 'A beautiful island in Indonesia known for its temples and beaches.',
        'image': 'assets/images/bali.jpg', // Replace with actual image path
      },
      {
        'name': 'Tokyo',
      ...
      },
      {
        ...
        'image': 'assets/images/new_york.jpg', // Replace with actual image path
      },
